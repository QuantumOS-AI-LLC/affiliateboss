-- Advanced Seed Data for Complete Affiliate System
...
-- Generate KPI Daily Stats (Last 30 days)
...
-- Update user balances and lifetime earnings based on commissions
UPDATE users SET 
  current_balance = 198.85,
  pending_balance = 49.75,
  lifetime_earnings = 248.60,
...
UPDATE users SET 
  current_balance = 155.20,
  pending_balance = 0.00,
  lifetime_earnings = 155.20,
...
UPDATE users SET 
  current_balance = 311.85,
  pending_balance = 103.95,
  lifetime_earnings = 415.80,
  commission_profile_id = 3,
  performance_tier = 'platinum',
  min_payout_amount = 10.00,
  payout_frequency = 'weekly',
