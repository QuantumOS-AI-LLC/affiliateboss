...
async function runTests() {
    ...
    const tests = [
        {
            name: 'Test Links API',
            url: 'http://localhost:3000/api/links?api_key=api_key_john_123456789'
        },
        {
            name: 'Test Dashboard',
            url: 'http://localhost:3000/api/dashboard?api_key=api_key_john_123456789'
        },
        {
            name: 'Test Commission Summary',
            url: 'http://localhost:3000/api/commissions/summary?api_key=api_key_john_123456789'
        },
        {
            name: 'Test Products',
            url: 'http://localhost:3000/api/products?api_key=api_key_john_123456789'
        }
    ];
